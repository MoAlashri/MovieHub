...
export default function MovieCard({ movieId, name, vote, src }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="w-[250px]  bg-surface rounded-lg rounded-t-3xl m-2 shadow-lg hover:scale-105 duration-300 cursor-pointer relative"
    >
      <img
        src={`https://image.tmdb.org/t/p/w500${src}`}
        className="w-100 rounded-3xl rounded-b-none h-[250px] mb-6"
        alt=""
      />
      ...
      <h3 className="p-2 text-sm font-bold text-slate-900">{name}</h3>
